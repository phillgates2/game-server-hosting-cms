 ...
 *
 * Kept out of the generic site-settings form because the bot token is a
 * credential: it goes through /api/settings/discord (admin only, never echoed
 * back) rather than /api/site-settings, whose GET is public.
 *
